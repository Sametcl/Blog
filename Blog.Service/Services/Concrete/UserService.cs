...
namespace Blog.Service.Services.Concrete
{
    public class UserService : IUserService
    {
        ...
        public UserService(IUnitOfWork unitOfWork, IMapper mapper, IImageHelper imageHelper, SignInManager<AppUser> signInManager, IHttpContextAccessor httpContextAccessor, UserManager<AppUser> userManager, RoleManager<AppRole> roleManager)
        {
